        ...
        <div class="row">
          <div class="col-12 col-md-6 order-md-1 order-last">
            ...
            <p class="text-subtitle text-muted">
              Silahkan ubah form berikut ini
            </p>
          </div>
          ...
          <div class="col-md-6 col-12">
            <div class="card">
              <div class="card-content">
                <div class="card-body">
                  <form action="{{ route('datpas.update', $pasiens->id) }}" method="post" class="form form-horizontal">
                    @method('put')
                    @csrf
                    <div class="form-body">
                      <div class="row">
                        <div class="col-md-4">
                          <label for="rekam_medis"
                        ...
                        <div class="col-md-8 form-group">
                          <input
                            ...
                            value="{{ old('rek_medis', $pasiens -> rek_medis)  }}"
                          />
                          @error('rek_medis')
